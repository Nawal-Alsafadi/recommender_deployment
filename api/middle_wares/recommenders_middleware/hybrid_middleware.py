...
def train_hybrid_payload(next_to):
    """
    Middleware for training hybrid models.
    ...
    def wrapper(*args, **kwargs):
        ...
        attribute_column = data.get("attribute_column")
        ...
        if not user_column or not item_column or not rating_column or not csv_path:
            return make_response(jsonify({
                "message": "user_column, item_column, rating_column, attribute_column, and csv_path are required",
                "success": False
            })), 400
        ...
        return next_to(clear_data=clear_data, user_column=user_column, item_column=item_column, rating_column=rating_column, attribute_column=attribute_column, csv_path=csv_path, *args, **kwargs)
